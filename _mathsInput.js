  ...
  for (var i = 0; i < inputs.length; i++) {
    ...
    if (typeof object.leftText == "object") {
      if (typeof object.leftText[i] == "object") {
        ...
        var fontSize =
          inputs[i].fontSize || 0.5 * (inputs[i].height / maxLines);
        ...
        drawMathsText(
          ...
          fontSize,
          inputs[i].left - 4,
          inputs[i].top + 0.5 * inputs[i].height,
          false,
          [],
          "right",
          "middle",
    ...
    if (typeof object.rightText == "object") {
      if (typeof object.rightText[i] == "object") {
        ...
        drawMathsText(
          ...
          object.rightText[i],
          fontSize,
          inputs[i].left + inputs[i].width + 15,
          inputs[i].top + 0.5 * inputs[i].height,
          false,
          [],
          "left",
        ...
        if (typeof inputs[i].offset === "undefined")
          inputs[i].offset = [textMeasure[0] + 5, 0];
    ...
    var data = [
      inputs[i].left + inputs[i].width + 13 + inputs[i].offset[0],
      inputs[i].top + 0.5 * inputs[i].height - 25 + inputs[i].offset[1],
      40,
      50,
      false,
      false,
    ...
    var data2 = [
      inputs[i].left + inputs[i].width + 20 + inputs[i].offset[0],
      inputs[i].top + 0.5 * inputs[i].height - 20 + inputs[i].offset[1],
      32,
      40,
      false,
      false,
...
function moveMathsInput(input, left, top) {
  ...
  resizeCanvas2(
    input.cursorCanvas,
    input.cursorData[100],
    input.cursorData[101]
  );
  ...
  if (typeof input.leftRightTextCanvas !== "undefined") {
    ...
    resizeCanvas2(
      ...
      input.leftRightTextCanvas.data[100],
      input.leftRightTextCanvas.data[101]
    );
  }
}
function enlargeMathsInput(input, sf) {
  // be careful!
...
function setMathsInputZIndex(input, zIndex) {
  if (typeof input.leftRightTextCanvas == "object")
    input.leftRightTextCanvas.style.zIndex = zIndex;
  ...
  if (typeof input.cursorCanvas == "object")
    input.cursorCanvas.style.zIndex = zIndex;
}
...
function setMathsInputText(mathsInputObj, opt_newText, opt_newCursorPos) {
  // eg. setMathsInputText(j37mathsInput[3]);
  var newText;
  if (un(opt_newText)) {
    newText = [""];
...
function setMathsInputTextToInitialTags(m) {
  ...
  if (
    !un(m.richText) &&
    typeof m.richText[0] == "string" &&
    m.richText[0].indexOf("<<") == 0
  ) {
    for (c = 2; c < m.richText[0].length; c++) {
      if (
        m.richText[0].slice(c).indexOf(">>") == 0 &&
        m.richText[0].slice(c).indexOf(">><<") !== 0
      ) {
...
function createMathsInput2(object) {
  ...
  var transparent;
  if (typeof object.transparent == "boolean") {
  ...
  var border;
  if (typeof object.border == "boolean") {
  ...
  var inputObject = createMathsInput(
    0,
    left,
    top,
    width,
...
function createMathsInput(
  ...
  var startTags =
    ...
    ">><<color:" +
    textColor +
    ">><<backColor:none>><<bold:false>><<italic:false>><<align:" +
    textAlign +
    ">>";
  ...
  function makeInputCanvas(l, t, w, h, v, d, p, z) {
    ...
    for (var i = 0; i < 8; i++) {
      canvas.data[i + 100] = canvas.data[i];
    }
    resizeCanvas3(canvas);
    return canvas;
  }

  var textCanvas = makeInputCanvas(
    left,
    top,
    width,
    height,
  ...
  var cursorCanvas = makeInputCanvas(
    left,
    top,
    width,
    height,
...
function mathsInputFrac(e) {
  mathsInputElement("['frac', [''], ['']]");
}
function mathsInputPow(e) {
  mathsInputElement("['power', false, ['']]");
}
function mathsInputSubs(e) {
  mathsInputElement("['subs', [''], ['']]");
}
function mathsInputRoot(e) {
  mathsInputElement("['root', [''], ['']]");
}
function mathsInputSqrt(e) {
  mathsInputElement("['sqrt', ['']]");
}
function mathsInputSin(e) {
  mathsInputElement("['sin', ['']]");
}
function mathsInputCos(e) {
  mathsInputElement("['cos', ['']]");
}
function mathsInputTan(e) {
  mathsInputElement("['tan', ['']]");
}
function mathsInputInvSin(e) {
  mathsInputElement("['sin-1', ['']]");
}
function mathsInputInvCos(e) {
  mathsInputElement("['cos-1', ['']]");
}
function mathsInputInvTan(e) {
  mathsInputElement("['tan-1', ['']]");
}
function mathsInputLn(e) {
  mathsInputElement("['ln', ['']]");
}
function mathsInputLog(e) {
  mathsInputElement("['log', ['']]");
}
function mathsInputLogBase(e) {
  mathsInputElement("['logBase', [''], ['']]");
}
function mathsInputAbs(e) {
  mathsInputElement("['abs', ['']]");
}
function mathsInputExp(e) {
  mathsInputElement("['exp', ['']]");
}
function mathsInputSigma1(e) {
  mathsInputElement("['sigma1', ['']]");
}
function mathsInputSigma2(e) {
  mathsInputElement("['sigma2', [''], [''], ['']]");
}
function mathsInputInt1(e) {
  mathsInputElement("['int1', ['']]");
}
function mathsInputInt2(e) {
  mathsInputElement("['int2', [''], [''], ['']]");
}
function mathsInputVectorArrow(e) {
  mathsInputElement("['vectorArrow', ['']]");
}
function mathsInputBar(e) {
  mathsInputElement("['bar', ['']]");
}
function mathsInputHat(e) {
  mathsInputElement("['hat', ['']]");
}
function mathsInputRecurring(e) {
  mathsInputElement("['recurring', ['']]");
}
function mathsInputColVector2d(e) {
  mathsInputElement("['colVector2d', [''], ['']]");
}
function mathsInputColVector3d(e) {
  mathsInputElement("['colVector3d', [''], [''], ['']]");
}
function mathsInputMixedNum(e) {
  mathsInputElement("['mixedNum', [''], [''], ['']]");
}
function mathsInputLim(e) {
  mathsInputElement("['lim', [''], ['']]");
}

function mathsInputCut() {
  if (currMathsInput.selected == false) return;
  mathsInputCopy();
  currMathsInput.cursorPos = Math.min(
    currMathsInput.selectPos[0],
    currMathsInput.selectPos[1]
  );
...
function mathsInputElement(elementString) {
  ...
  var after = parent.slice(pos);
  if (
    !un(currMathsInput.preText) &&
    currMathsInput.preText !== null &&
    currMathsInput.preText !== ""
  ) {
    before += currMathsInput.preText;
  }
  if (
    !un(currMathsInput.postText) &&
    currMathsInput.postText !== null &&
    currMathsInput.postText !== ""
  ) {
...
function mathsInputNewLine() {
  ...
  if (typeof currMathsInput.richText[cursorPos[0]] == "string") {
    ...
    if (
      currMathsInput.richText[cursorPos[0]]
        .slice(slicePos)
        .indexOf("<<align:") == 0
    ) {
      slicePos +=
        currMathsInput.richText[cursorPos[0]].slice(slicePos).indexOf(">>") + 2;
    }
    slicePos = mathsInputAvoidTagSplit(
      currMathsInput.richText[cursorPos[0]],
      slicePos
    );

    currMathsInput.richText[cursorPos[0]] =
      currMathsInput.richText[cursorPos[0]].slice(0, slicePos) +
      "<<br>>" +
      currMathsInput.richText[cursorPos[0]].slice(slicePos);
    mathsInputMapCursorPos();
    ...
    for (
      var i = currMathsInput.cursorPos;
      i < currMathsInput.cursorMap.length;
      i++
    ) {
      cursorPosShiftCount++;
      ...
      if (cursorPos[0] < currMathsInput.cursorMap[i][0]) {
        if (
          typeof currMathsInput.richText[currMathsInput.cursorMap[i][0]] ==
          "string"
        ) {
          cursorPos = currMathsInput.cursorMap[i];
          currMathsInput.richText[currMathsInput.cursorMap[i][0]] =
            "<<br>>" + currMathsInput.richText[currMathsInput.cursorMap[i][0]];
          break;
        } else {
    ...
    for (
      ...
      if (cursorPos[0] < currMathsInput.cursorMap[i][0]) {
        if (
          ...
          cursorPos = currMathsInput.cursorMap[i];
          currMathsInput.richText[currMathsInput.cursorMap[i][0]] =
            ins + currMathsInput.richText[currMathsInput.cursorMap[i][0]];
          break;
        } else {
          // this shouldn't happen?? All elements will be separated by a text string
        }
...
function mathsInputTabPrev() {
  ...
  for (var i = 0; i < mathsInput[pageIndex].length; i++) {
    if (
      i == currMathsInputId ||
      mathsInput[pageIndex][i].canvas.parentNode !== container ||
      mathsInput[pageIndex][i].active == false
    )
      continue;
    if (
      mathsInput[pageIndex][i].data[100] <
        mathsInput[pageIndex][currMathsInputId].data[100] &&
      mathsInput[pageIndex][i].data[101] ==
        mathsInput[pageIndex][currMathsInputId].data[101]
    ) {
      // if directly to the left
      ...
      // if directly to the right or below
      if (typeof y == "undefined") {
        y = mathsInput[pageIndex][i].data[101];
        x = mathsInput[pageIndex][i].data[100];
        currBest2 = i;
      } else if (
        mathsInput[pageIndex][i].data[101] > y ||
        (mathsInput[pageIndex][i].data[101] == y &&
          mathsInput[pageIndex][i].data[100] > x)
      ) {
        y = mathsInput[pageIndex][i].data[101];
        x = mathsInput[pageIndex][i].data[100];
        currBest2 = i;
...
function startMathsInput(e, startCursorPos) {
  ...
  for (i = 0; i < mathsInput[pageIndex].length; i++) {
    if (
      mathsInput[pageIndex][i].cursorCanvas == inputCanvas ||
      mathsInput[pageIndex][i].canvas == inputCanvas ||
      mathsInput[pageIndex][i] == inputCanvas
    ) {
  ...
  if (
    currMathsInput.transparent == false &&
    currMathsInput.selectColor !== "none"
  ) {
  ...
  if (
    currMathsInput.selectable == true &&
    typeof startCursorPos == "undefined"
  ) {
  ...
  if (!un(currMathsInput.markPos)) {
    currMathsInput.markctx.clearRect(
      currMathsInput.markPos[0] - 5,
      currMathsInput.markPos[1] - 5,
      currMathsInput.markPos[2] + 10,
      currMathsInput.markPos[3] + 10
    );
  }
  //shiftOn = false;
  //ctrlOn = false;
  ...
  if (
    !un(window.textMenu) &&
    typeof textMenu.show == "function" &&
    textMenu.showOnStartInput == true
  ) {
    textMenu.update();
    textMenu.show();
  }
...
function getClosestTextPos(mathsInput) {
  ...
  var mousePos = [
    mouse.x - mathsInput.data[100],
    mouse.y - mathsInput.data[101],
  ];
  ...
  for (var pos = 0; pos < map.length; pos++) {
    ...
    if (pos == 0) {
      closestDist = distancePointToLineSegment(
        mousePos,
        [loc.left, loc.top],
      ...
      closestPos = pos;
      vertDist = Math.min(
        Math.abs(mousePos[1] - loc.top),
        Math.abs(mousePos[1] - (loc.top + loc.height))
      );
      if (mousePos[1] >= loc.top && mousePos[1] <= loc.top + loc.height)
        vertDist = 0;
      closestVertDist = vertDist;
    } else {
      var newDist = distancePointToLineSegment(
        mousePos,
        [loc.left, loc.top],
        [loc.left, loc.top + loc.height]
      );
      var newVertDist = Math.min(
        Math.abs(mousePos[1] - loc.top),
        Math.abs(mousePos[1] - (loc.top + loc.height))
      );
      if (mousePos[1] >= loc.top && mousePos[1] <= loc.top + loc.height)
        newVertDist = 0;
      if (
        newVertDist < closestVertDist ||
        (newVertDist == closestVertDist && newDist < closestDist)
      ) {
...
function endMathsInput(e) {
  if (
    !un(e) &&
    !un(keyboardButton1) &&
    !un(keyboardButton1[pageIndex]) &&
    e.target == keyboardButton1[pageIndex]
  )
    return;
  if (
    !un(e) &&
    !un(keyboardButton2) &&
    !un(keyboardButton2[pageIndex]) &&
    e.target == keyboardButton2[pageIndex]
  )
    return;
...
function deselectMathsInput(e, diffInput) {
  ...
  if (
    ...
    e.target !== currMathsInput.canvas &&
    !un(mathsInput[pageIndex])
  ) {
    for (var i = 0; i < mathsInput[pageIndex].length; i++) {
  ...
  if (
    (typeof diffInput !== "undefined" && diffInput == true) ||
    diffInputTest > -1
  ) {
  } else {
    hideKeyboard2(true);
  ...
  currMathsInput.canvas.style.backgroundColor =
    currMathsInput.backColor || "transparent";
...
function setSelectPositions() {
  ...
  if (typeof selPos1 !== "undefined") {
    ...
    for (var i = 0; i < selPos1.length - 1; i++) {
      txt = txt[selPos1[i]];
    }
  ...
  if (typeof selPos2 !== "undefined") {
    var txt = clone(currMathsInput.richText);
    for (var i = 0; i < selPos2.length - 1; i++) {
      txt = txt[selPos2[i]];
    }
...
function removeSelectTags() {
  ...
  function stringHandler(string) {
    ...
    for (var j = string.length - 1; j >= 0; j--) {
      ...
      if (slice.indexOf("<<selected:false>>") == 0) {
        ...
        if (
          typeof map1 !== "undefined" &&
          arraysEqual(pos, map1) == true &&
          map2 > j
        ) {
  ...
  if (typeof map2 !== "undefined") {
    currMathsInput.cursorMap[currMathsInput.cursorPos][
      currMathsInput.cursorMap[currMathsInput.cursorPos].length - 1
    ] = map2;
  }
...
function deleteSelected() {
  ...
  function stringHandler(string) {
    ...
    for (var j = 0; j < string.length; j++) {
      ...
      if (
        sel == true &&
        (slice.indexOf("<<font") == 0 ||
          slice.indexOf("<<bold") == 0 ||
          slice.indexOf("<<italic") == 0 ||
          slice.indexOf("<<color") == 0 ||
          slice.indexOf("<<back") == 0)
      ) {
        savedTags += slice.slice(0, slice.indexOf(">>") + 2);
      }
    }
...
function mathsInputMapCursorPos() {
  // (re-)builds cursor map
  ...
  for (var i = 1; i < cursorMap.length; i++) {
    ...
    for (var j = 0; j < cursorMap[i].length - 1; j++)
      richText = richText[cursorMap[i][j]];
    ...
    if (typeof currMathsInput.breakPoints == "object") {
      for (var k = 0; k < currMathsInput.breakPoints.length - 1; k++) {
        var breakPoint = currMathsInput.allMap[currMathsInput.breakPoints[k]];
        if (
          breakPoint[0] == cursorMap[i][0] &&
          breakPoint[1] < cursorMap[i][1]
        ) {
          char--;
        }
      }
    ...
    if (
      richText.slice(char - 2).indexOf(">>") == 0 &&
      richText.slice(char - 6).indexOf("<<br>>") !== 0
    ) {
      ...
      for (var j = 0; j < leftText.length; j++) {
        if (
          richText.slice(char - j, char).indexOf("<<") == 0 &&
          (leftText.slice(char - j - 2, char).indexOf(">>") !== 0 ||
            leftText.slice(char - j - 6, char).indexOf("<<br>>") == 0)
        ) {
          tagCharCount = j;
          break;
        }
      ...
      currMathsInput.cursorMap[i][currMathsInput.cursorMap[i].length - 1] -=
        tagCharCount;
    }
  }
...
function combineSpacesCursor(array) {
  ...
  if (array.length > 1) {
    for (var gg = array.length - 1; gg >= 0; gg--) {
      ...
      if (typeof array[gg] == "object") {
        ...
        if (
          gg < array.length - 1 &&
          typeof array[gg] == "string" &&
          typeof array[gg + 1] == "string"
        ) {
          eval(
            "currMathsInput.richText" +
              arrayString +
              "[" +
              gg +
              "] += currMathsInput.richText" +
  ...
  arrayString = arrayString.slice(
    0,
    arrayString.lastIndexOf("[") - arrayString.length
  );
  return array;
}
...
function mathsInputCursorCoords() {
  ...
  if (
    typeof textMenu !== "undefined" &&
    typeof textMenu !== "undefined" &&
    typeof textMenu.update == "function"
  )
    textMenu.update();
}
...
function adjustForBreakPoints(pos, map, breakPoints) {
  ...
  if (typeof map == "undefined")
    map = currMathsInput.cursorMap[currMathsInput.cursorPos];
  if (typeof breakPoints == "undefined")
    breakPoints = currMathsInput.breakPoints;
...
function mathsInputCursorBlink() {
  ...
  currMathsInput.cursorctx.clearRect(0, 0, 1200, 700);
  currMathsInput.cursorCanvas.style.zIndex =
    currMathsInput.canvas.style.zIndex + 1;
  ...
  if (showCursorPos == true) {
    ...
    currMathsInput.cursorctx.lineWidth = 2;
    currMathsInput.cursorctx.beginPath();
    currMathsInput.cursorctx.moveTo(
      hAdjust + mathsInputCursor.x,
      vAdjust + mathsInputCursor.top
    );
    currMathsInput.cursorctx.lineTo(
      hAdjust + mathsInputCursor.x,
      vAdjust + mathsInputCursor.bottom
    );
    currMathsInput.cursorctx.closePath();
    currMathsInput.cursorctx.stroke();
    currMathsInput.cursorctx.restore();
...
function hardKeyMathsInput(e) {
  // if a key is pressed via the hardware keyboard
  e.preventDefault();
  if (inputState == true) {
    var charCode = e.keyCode; // determine which key has been pressed
    var keysToIgnore = [
      16, 17, 18, 27, 33, 34, 35, 36, 46, 112, 113, 114, 115, 116, 117, 118,
      119, 120, 121, 122, 123, 144, 223,
    ];
    ...
    switch (charCode) {
      ...
      case 38: // up arrow
        ...
        if (parent[0] == "frac" && cursorPos[cursorPos.length - 3] == 2) {
          ...
          for (var i = 0; i < currMathsInput.breakPoints.length - 1; i++) {
            if (
              currMathsInput.allMap[currMathsInput.breakPoints[i]][0] <
                currMathsInput.cursorMap[currMathsInput.cursorPos][0] ||
              (currMathsInput.allMap[currMathsInput.breakPoints[i]][0] ==
                currMathsInput.cursorMap[currMathsInput.cursorPos][0] &&
                currMathsInput.allMap[currMathsInput.breakPoints[i]][1] <
                  currMathsInput.cursorMap[currMathsInput.cursorPos][1])
            ) {
              lowerBreakPoints.unshift(
                currMathsInput.allMap[currMathsInput.breakPoints[i]]
              );
            }
          }
          if (lowerBreakPoints.length == 0) {
            ...
            for (
              var i = 0;
              i < currMathsInput.cursorMap[currMathsInput.cursorPos].length;
              i++
            ) {
              textLoc =
                textLoc[currMathsInput.cursorMap[currMathsInput.cursorPos][i]];
            }
            ...
            for (var i = 0; i < currMathsInput.cursorMap.length; i++) {
              ...
              if (
                currMathsInput.cursorMap[i][0] < lowerBreakPoints[0][0] ||
                (currMathsInput.cursorMap[i][0] == lowerBreakPoints[0][0] &&
                  currMathsInput.cursorMap[i][1] < lowerBreakPoints[0][1])
              ) {
                ...
                if (lowerBreakPoints.length > 1) {
                  if (
                    currMathsInput.cursorMap[i][0] < lowerBreakPoints[1][0] ||
                    (currMathsInput.cursorMap[i][0] == lowerBreakPoints[1][0] &&
                      currMathsInput.cursorMap[i][1] < lowerBreakPoints[1][1])
                  )
                    continue;
                }
      ...
      case 39: // right arrow
        ...
        if (
          ...
          removeSelectTags();
          mathsInputMapCursorPos();
          currMathsInput.cursorPos = Math.max(
            currMathsInput.selectPos[0],
            currMathsInput.selectPos[1]
          );
          currMathsInput.selectPos = [];
          ...
          currMathsInput.cursorPos <
          currMathsInput.cursorMap.length - 1
        ) {
          currMathsInput.cursorPos++;
          mathsInputCursorCoords();
        } else {
      ...
      case 40: // down arrow
        ...
        // get the parent of the current string
        var parent = currMathsInput.richText;
        for (var aa = 0; aa < cursorPos.length - 3; aa++) {
          parent = parent[cursorPos[aa]];
        }
        if (parent[0] == "frac" && cursorPos[cursorPos.length - 3] == 1) {
          ...
          do {
            ...
            for (var aa = 0; aa < cursorPos2.length - 3; aa++) {
              parent2 = parent2[cursorPos2[aa]];
            }
          } while (
            parent2 !== parent ||
            (parent2 == parent && cursorPos2[cursorPos.length - 3] !== 2)
          );
          ...
          if (higherBreakPoints.length == 0) {
            ...
            for (var i = 0; i < currMathsInput.cursorMap.length; i++) {
              ...
              if (
                currMathsInput.cursorMap[i][0] > higherBreakPoints[0][0] ||
                (currMathsInput.cursorMap[i][0] == higherBreakPoints[0][0] &&
                  currMathsInput.cursorMap[i][1] > higherBreakPoints[0][1])
              ) {
                // if it is above the current line
                ...
                if (higherBreakPoints.length > 1) {
                  if (
                    currMathsInput.cursorMap[i][0] > higherBreakPoints[1][0] ||
                    (currMathsInput.cursorMap[i][0] ==
                      higherBreakPoints[1][0] &&
                      currMathsInput.cursorMap[i][1] > higherBreakPoints[1][1])
                  )
                    continue;
                }
                var loc = currMathsInput.textLoc;
      ...
      case 8: // backspace key pressed
        ...
        if (currMathsInput.selected == true) {
          ...
          if (cursorPos.length > 1) {
            ...
            for (var i = 0; i < cursorPos.length - 2; i++) {
              parent = parent[cursorPos[i]];
            }
          }
          var grandParent;
          if (cursorPos.length > 2) {
            ...
            for (var i = 0; i < cursorPos.length - 3; i++) {
              grandParent = grandParent[cursorPos[i]];
            }
          }
          ...
          if (text !== "") {
            ...
            if (parent.length == 1) {
              // ie. empty string is only sub-element
              var elemsOneParam = [
                "sqrt",
                "pow",
                "power",
              ...
              if (
                elemsOneParam.indexOf(grandParent[0]) > -1 ||
                (elemsTwoParams.indexOf(grandParent[0]) > -1 &&
                  cursorPos[cursorPos.length - 3] == 1) ||
                (elemsThreeParams.indexOf(grandParent[0]) > -1 &&
                  cursorPos[cursorPos.length - 3] == 1)
              ) {
      ...
      case 13: // enter key pressed
        if (
          currMathsInput.maxLines > 1 ||
          (typeof draw !== "undefined" && draw.drawMode == "textEdit")
        ) {
          if (currMathsInput.selected == true) {
            currMathsInput.cursorPos = Math.min(
              currMathsInput.selectPos[0],
      ...
      default:
        ...
        if (currMathsInput.text[0].length >= currMathsInput.maxChars) {
          break;
        }
        if (
          e.getModifierState("Shift") == true &&
          charCode ==
            54 /* && currMathsInput.cursorMap[currMathsInput.cursorPos].length == 2*/
        ) {
          // if hat symbol is used and current text element is a text string
          mathsInputPow();
          break;
        }
        if (keysToIgnore.indexOf(charCode) == -1) {
          ...
          var caps = false;
          if (e.getModifierState("Shift") || e.getModifierState("CapsLock"))
            caps = true;
...
function softKeyMathsInput(e) {
  ...
  if (inputState == true) {
    ...
    if (keyValue == "delete") {
      ...
      text =
        text.slice(0, slicePos) + pre + keyValue + post + text.slice(slicePos);
      ...
      if (
        cursorPos[cursorPos.length - 1] + 1 == text.length &&
        typeof currMathsInput.cursorMap[currMathsInput.cursorPos + 1] !==
          "undefined"
      ) {
        ...
        for (var aa = 0; aa < nextCursorPos.length - 3; aa++) {
          nextElem = nextElem[nextCursorPos[aa]];
        }
...
function measureMathsInputText(input) {
  ...
  if (input.textAlign == "center") {
    leftPoint = 0.5 * input.data[2];
  }
  if (typeof input.richText[input.richText.length - 1] !== "string") {
    input.richText.push("");
  }
  return drawMathsText(
    input.ctx,
    input.richText,
    input.fontSize,
    leftPoint,
...
function drawMathsInputText(input, ctxLocal, sf, useRelPos) {
  ...
  if (input.border == true) {
    if (typeof input.varSize == "object") {
      ...
      roundedRect(
        ...
        borderLeft,
        borderTop,
        input.data[102] * sf - input.borderWidth * sf,
        input.data[103] * sf - input.borderWidth * sf,
        radius,
        input.borderWidth * sf,
        input.borderColor,
        input.backColor,
        input.borderDash
      );
  ...
  if (ownCanvas == false) {
    ...
    if (
      boolean(useRelPos, true) == true &&
      typeof draw !== "undefined" &&
      typeof draw !== "undefined" &&
      typeof draw.drawRelPos !== "undefined"
    ) {
  ...
  if (typeof input.varSize == "object" && ownCanvas == true) {
    ...
    resizeCanvas(
      ...
      input.cursorData[100],
      input.cursorData[101],
      input.cursorData[102],
      input.cursorData[103]
    );
  }
  ...
  if (!un(draw) && draw.drawMode == "textEdit") {
    ...
    if (obj.type == "text" && obj.mathsInput.canvas == input.canvas) {
      if (
        input.cursorData[103] > obj.height ||
        input.cursorData[102] > obj.width
      ) {
        for (var i = 0; i < draw.path.length; i++) {
          if (draw.path[i].selected == true) {
            if (input.cursorData[103] > obj.height)
              obj.height = input.cursorData[103];
            if (input.cursorData[102] > obj.width)
              obj.width = input.cursorData[102];
...
function mathsInputAddChar(mInput, char) {
  ...
  var newLoc = drawMathsText(
    mInput.ctx,
    char,
    fontSize,
    loc.left,
    loc.top + 0.5 * loc.height,
    false,
    [],
    "left",
    "middle",
  ...
  eval(
    "mInput.richText" + evalString + "=mInput.richText" + evalString + "+char"
  );
    ...
    for (var i = 0; i < arr.length; i++) {
      if (typeof arr[i] == "object") {
        ...
        for (var splitElem = 0; splitElem < splitText.length; splitElem++) {
          if (
            splitText[splitElem].indexOf("<<") == 0 &&
            splitText[splitElem].indexOf("<<br>>") !== 0
          ) {
...
function createJsString(angleMode) {
  ...
  function subJS(elem, addMultIfNecc) {
    ...
    if (typeof elem == "string") {
      ...
      if (
        jsArray[depth] !== "" &&
        /[\+\-\u00D7\u00F7\*\/\=\[(]/.test(jsArray[depth].slice(-1)) == false
      )
        subText += "*";
      depth++;
      position.push(0);
      ...
      if (jsArray[depth] !== "") {
        if (jsArray[depth].charAt(jsArray[depth].length - 1) == ")") {
          ...
          /[A-Za-z]/g.test(jsArray[depth].charAt(jsArray[depth].length - 1)) ==
          true
        ) {
...
function splitText(text) {
  ...
  for (i = 0; i <= text.length; i++) {
    ...
    if (fracStartPos > -1 || rootStartPos > -1 || powerStartPos > -1) {
      ...
      textSplitPoints[splitPointCount][0] = Math.min(
        fracStartPos,
        rootStartPos,
        powerStartPos
      );
  ...
  if (textSplitPoints.length == 0) {
    return text;
  }

  for (i = 0; i < textSplitPoints.length; i++) {
    text =
      text.substring(0, textSplitPoints[i][0] + i * 2 * delimiter.length) +
      delimiter +
      text.substring(
        textSplitPoints[i][0] + i * 2 * delimiter.length,
        textSplitPoints[i][1] + 1 + i * 2 * delimiter.length
      ) +
      delimiter +
      text.substring(
        textSplitPoints[i][1] + 1 + i * 2 * delimiter.length,
  ...
  for (i = 0; i < splitArray.length; i++) {
    var type = 0;
    if (splitArray[i].indexOf("frac(") == 0) {
      type = "frac";
    }
    if (splitArray[i].indexOf("root(") == 0) {
      type = "root";
    }
    if (splitArray[i].indexOf("power(") == 0) {
      type = "power";
    }
    if (type == 0) {
      if (splitArray[i] !== "") {
      ...
      var params = splitArray[i].substring(
        type.length + 1,
...
function logText(clearConsole) {
  ...
  for (var i = 0; i < input.cursorMap.length; i++) {
    ...
    for (var j = 0; j < input.cursorMap[i].length - 1; j++) {
      char = char[input.cursorMap[i][j]];
    }
...
function isMouseOverText(mathsInput) {
  ...
  for (var i = 0; i < mathsInput.cursorMap.length; i++) {
    ...
    for (var j = 0; j < mathsInput.cursorMap[i].length; j++) {
      textLoc = textLoc[mathsInput.cursorMap[i][j]];
    }
    locs.push(textLoc);
  }
  ...
  for (var i = 0; i < locs.length; i++) {
    if (
      mouse.x >= left + locs[i].left &&
      mouse.x <= left + locs[i].left + locs[i].width &&
      mouse.y >= top + locs[i].top &&
      mouse.y <= top + locs[i].top + locs[i].height
    ) {
      return true;
    }
  }
        ...
        for (var k = splitString[j].length; k >= 0; k--) {
          ...
          if (slice.indexOf("<<bold:") == 0) {
            if (bold.char == false) {
              ...
              splitString[j] =
                splitString[j].slice(0, k) +
                splitString[j].slice(k + slice.indexOf(">>") + 2);
            } else {
              var value = splitString[j]
                .slice(k + 7, k + splitString[j].slice(k).indexOf(">>"))
                .toLowerCase();
              if (value == bold.value) {
                // repeated tag - !!
              } else {
            ...
            if (italic.char == false) {
              ...
              var value = splitString[j]
                .slice(k + 9, k + splitString[j].slice(k).indexOf(">>"))
                .toLowerCase();
            ...
            if (fontSize.char == false) {
              ...
              var value = splitString[j]
                .slice(k + 11, k + splitString[j].slice(k).indexOf(">>"))
                .toLowerCase();
            ...
            if (color.char == false) {
              ...
              var value = splitString[j]
                .slice(k + 8, k + splitString[j].slice(k).indexOf(">>"))
                .toLowerCase();
            ...
            if (backColor.char == false) {
              ...
              var value = splitString[j]
                .slice(k + 12, k + splitString[j].slice(k).indexOf(">>"))
                .toLowerCase();
    ...
    if (textArray.length > 1) {
      for (var gg = textArray.length - 1; gg >= 0; gg--) {
        if (typeof textArray[gg] == "object") {
          ...
          if (
            gg < textArray.length - 1 &&
            typeof textArray[gg] == "string" &&
            typeof textArray[gg + 1] == "string"
          ) {
