...
function addDrawTools(object) {
  ...
  if (
    typeof object.protractor !== "undefined" ||
    typeof object.compass !== "undefined" ||
    typeof object.ruler !== "undefined"
  ) {
  ...
  var drawCanvas = [
    createCanvas(
      drawArea[0] + drawRelPos[0],
      drawArea[1] + drawRelPos[1],
      drawArea[2],
      drawArea[3],
      true,
      false,
  ...
  draw.cursors = {
    ...
    update: function () {
      ...
      if (typeof draw.ruler !== "undefined") {
        ...
        draw.rulerEdgeCursorHotspot1 = [
          25 - 18 * Math.sin(draw.ruler.angle),
          25 + 18 * Math.cos(draw.ruler.angle),
        ];
        ...
        draw.rulerEdgeCursorHotspot2 = [
          25 - 18 * Math.sin(Math.PI + draw.ruler.angle),
          25 + 18 * Math.cos(Math.PI + draw.ruler.angle),
        ];
      ...
      drawArrow({
        ctx: ctx,
        startX: 25 - 6 / Math.sqrt(2),
        startY: 25 + 6 / Math.sqrt(2),
        finX: 25 + 6 / Math.sqrt(2),
        finY: 25 - 6 / Math.sqrt(2),
        arrowLength: 4,
        color: "#000",
        lineWidth: 5,
        fillArrow: true,
      ...
      draw.upRightArrowCursorHotspot = [
        25 + 6 / Math.sqrt(2),
        25 - 6 / Math.sqrt(2),
      ];
      ...
      this.pen =
        ...
        draw.penCursor +
        '") ' +
        draw.penCursorHotspot[0] +
        " " +
        draw.penCursorHotspot[1] +
        ", auto";
      this.cross =
        'url("' +
        draw.lineCursor +
      ...
      this.rulerPen1 =
        'url("' +
        draw.rulerEdgeCursor1 +
        '") ' +
        draw.rulerEdgeCursorHotspot1[0] +
        " " +
        draw.rulerEdgeCursorHotspot1[1] +
        ", auto";
      this.rulerPen2 =
        'url("' +
        draw.rulerEdgeCursor2 +
        '") ' +
        draw.rulerEdgeCursorHotspot2[0] +
        " " +
        draw.rulerEdgeCursorHotspot2[1] +
        ", auto";
      this.ruler180 =
        'url("' +
        draw.ruler180 +
        '") ' +
        draw.ruler180Hotspot[0] +
        " " +
        draw.ruler180Hotspot[1] +
        ", auto";
      this.fill =
        'url("' +
        draw.fillCursor +
        '") ' +
        draw.fillCursorHotspot[0] +
        " " +
        draw.fillCursorHotspot[1] +
        ", auto";
      this.downArrow =
        'url("' +
        draw.downArrowCursor +
        '") ' +
        draw.downArrowCursorHotspot[0] +
        " " +
        draw.downArrowCursorHotspot[1] +
        ", auto";
      this.rightArrow =
        'url("' +
        draw.rightArrowCursor +
        '") ' +
        draw.rightArrowCursorHotspot[0] +
        " " +
        draw.rightArrowCursorHotspot[1] +
        ", auto";
      this.upRightArrow =
        'url("' +
        draw.upRightArrowCursor +
        '") ' +
        draw.upRightArrowCursorHotspot[0] +
        " " +
        draw.upRightArrowCursorHotspot[1] +
        ", auto";
    },
  };
  if (typeof object.protractor == "object") {
    var buttonPos = object.protractor.buttonPos || [1120, 620];
    var protractorButton = createCanvas(
      buttonPos[0],
      buttonPos[1],
      55,
      55,
  ...
  if (typeof object.compass == "object") {
    ...
    var compassButton = createCanvas(
      buttonPos[0],
      buttonPos[1],
      55,
      55,
  ...
  if (typeof object.undo == "object") {
    ...
    undoButton.draw = function () {
      ...
      this.ctx.lineTo(
        13.5 - 10 * Math.sin(1 * Math.PI),
        27.5 + 10 * Math.cos(1 * Math.PI)
      );
      this.ctx.lineTo(
        13.5 - 10 * Math.cos(0.95 * Math.PI),
        27.5 - 10 * Math.sin(0.95 * Math.PI)
      );
  ...
  if (typeof object.clearPen == "object") {
    ...
    clearButton.draw = function () {
      ...
      text({
        ...
        top: (15 * s) / 55,
        textArray: [
          "<<font:Arial>><<fontSize:" + (20 * s) / 55 + ">><<align:center>>CLR",
        ],
      });
    };
    clearButton.click = function () {
  ...
  if (typeof object.compassHelp == "object") {
    ...
    var compassHelpButton = createCanvas(
      buttonPos[0],
      buttonPos[1],
      55,
      55,
    ...
    var compassHelpBox = createCanvas(
      helpBoxPos[0],
      helpBoxPos[1],
      500,
      420,
    ...
    compassHelpImage.onload = function () {
      compassHelpBox
        ...
        .drawImage(
          ...
          15,
          15,
          compassHelpImage.naturalWidth * 0.93,
          compassHelpImage.naturalHeight * 0.93
        );
    };
  ...
  if (typeof object.anglesAroundPoint == "object") {
    ...
    var anglesAroundPointButton = createCanvas(
      buttonPos[0],
      buttonPos[1],
      55,
      55,
  ...
  if (typeof object.lineEnds == "object") {
    ...
    var lineEndsButton = createCanvas(
      buttonPos[0],
      buttonPos[1],
      55,
      55,
    ...
    lineEndsButton.click = function () {
      ...
      if (draw.lineEndsVisible == true) {
        for (var i = 0; i < draw.lineEndStartButtons.length; i++) {
          showObj(
            draw.lineEndStartButtons[i],
            draw.lineEndStartButtons[i].data
          );
        }
        ...
        for (var i = 0; i < container.childNodes.length; i++) {
          if (
            draw.lineEndStartButtons.indexOf(container.childNodes[i]) == -1 &&
            draw.lineEndMidButtons.indexOf(container.childNodes[i]) == -1 &&
            draw.lineEndFinButtons.indexOf(container.childNodes[i]) == -1 &&
            draw.lineEndSizeButtons.indexOf(container.childNodes[i]) == -1
          ) {
    ...
    var lineEndsBackButton = createCanvas(
      left,
      top,
      120,
      220,
    ...
    roundedRect(
      lineEndsBackButton.getContext("2d"),
      3,
      3,
      114,
      214,
  ...
  if (typeof object.table == "object") {
    ...
    var tableSizeCanvas = createCanvas(
      left,
      top,
      cols * 25 + 20,
      rows * 25 + 40,
    ...
    tableSizeCanvas.draw = function () {
      ...
      if (draw.tableSizeCanvasDir == "below") {
        text({
          ...
          textArray: [
            "<<fontSize:14>>" +
              (draw.tableSize.rows + 1) +
              " x " +
              (draw.tableSize.cols + 1),
          ],
          left: 12,
          top: 5,
          width: 200,
    ...
    addListenerMove(tableSizeCanvas, function (e) {
      updateMouse(e);
      var col = Math.min(
        draw.tableSize.maxCols,
        Math.max(0, Math.floor((mouse.x - e.target.data[100] - 10) / 25))
      );
      var row = Math.min(
        draw.tableSize.maxRows,
        Math.max(0, Math.floor((mouse.y - e.target.data[101] - 30) / 25))
      );
  ...
  if (typeof object.distHoriz == "object") {
    ...
    var distHorizButton = createCanvas(
      buttonPos[0],
      buttonPos[1],
      55,
      55,
  ...
  if (typeof object.distVert == "object") {
    ...
    var distVertButton = createCanvas(
      buttonPos[0],
      buttonPos[1],
      55,
      55,
  ...
  if (typeof object.tableRowColChange == "object") {
    ...
    var left = buttonPos[0];
    var top = buttonPos[1] + 53;
    var tableRowColCanvas = createCanvas(
      left,
      top,
      200,
      260,
    ...
    tableRowColCanvas.draw = function () {
      ...
      text({
        context: ctx,
        textArray: ["<<fontSize:20>>Add rows above"],
        left: 10,
        top: 10,
        width: 180,
        height: 40,
      ...
      text({
        context: ctx,
        textArray: ["<<fontSize:20>>Add rows below"],
        left: 10,
        top: 50,
        width: 180,
        height: 40,
      ...
      text({
        context: ctx,
        textArray: ["<<fontSize:20>>Delete rows"],
        left: 10,
        top: 90,
        width: 180,
        height: 40,
      ...
      text({
        context: ctx,
        textArray: ["<<fontSize:20>>Add columns left"],
        left: 10,
        top: 130,
        width: 180,
        height: 40,
      ...
      text({
        context: ctx,
        textArray: ["<<fontSize:20>>Add columns right"],
        left: 10,
        top: 170,
        width: 180,
        height: 40,
      ...
      text({
        context: ctx,
        textArray: ["<<fontSize:20>>Delete columns"],
        left: 10,
        top: 210,
        width: 180,
        height: 40,
    ...
    addListenerMove(tableRowColCanvas, function (e) {
      ...
      if (
        mouse.x - e.target.data[100] < 10 ||
        mouse.x - e.target.data[100] > 190
      )
        sel = -1;
    ...
    addListener(tableRowColCanvas, function (e) {
      if (
        draw.tableRowColCanvas.selected < 0 ||
        draw.tableRowColCanvas.selected > 5
      )
        return;
      for (var i = 0; i < draw.path.length; i++) {
        if (draw.path[i].selected == true) {
                ...
                case 1: // add rows below
                  ...
                  if (draw.tableRowColCanvas.selected == 0) {
                    ...
                    var newHei = obj.heights
                      ...
                      .concat(newHeights)
                      .concat(
                        obj.heights.slice(selRows[selRows.length - 1] + 1)
                      );
                  }
                  obj.cells = newCel;
                  obj.heights = newHei;
                ...
                case 4: // add cols right
                  ...
                  for (var r = 0; r < cells.length; r++) {
                    ...
                    if (draw.tableRowColCanvas.selected == 3) {
                      ...
                      var newRow = obj.cells[r]
                        ...
                        .concat(newCells)
                        .concat(
                          obj.cells[r].slice(selCols[selCols.length - 1] + 1)
                        );
                    }
                    obj.cells[r] = newRow;
                  }
                  if (draw.tableRowColCanvas.selected == 3) {
                    ...
                    obj.widths = obj.widths
                      ...
                      .concat(newWidths)
                      .concat(
                        obj.widths.slice(selCols[selCols.length - 1] + 1)
                      );
                  }
                  break;
                case 2: // del rows
  ...
  if (typeof object.tableBorders == "object") {
    ...
    var left = buttonPos[0];
    var top = buttonPos[1] + 53;
    var tableBordersCanvas = createCanvas(
      left,
      top,
      400,
      170,
    ...
    tableBordersCanvas.draw = function () {
      ...
      text({
        context: ctx,
        textArray: ["<<fontSize:18>>Outer Border"],
        left: 0,
        top: 10,
        width: 200,
        height: 50,
      ...
      text({
        context: ctx,
        textArray: ["<<fontSize:18>>Inner Border"],
        left: 200,
        top: 10,
        width: 200,
        height: 50,
        ...
        if (draw.path[i].selected == true) {
          for (var j = 0; j < draw.path[i].obj.length; j++) {
            if (
              ...
              if (draw.path[i].obj[j].innerBorder.show == false)
                innerColor = "#FFC";
              ...
              if (draw.path[i].obj[j].outerBorder.show == false)
                outerColor = "#FFC";
      ...
      text({
        context: ctx,
        textArray: ["<<fontSize:16>>width " + outerWeight],
        left: 5,
        top: 130,
        width: 60,
        height: 30,
      ...
      text({
        context: ctx,
        textArray: ["<<fontSize:16>>dash " + outerDash[0]],
        left: 70,
        top: 130,
        width: 60,
        height: 30,
      ...
      text({
        context: ctx,
        textArray: ["<<fontSize:16>>gap " + outerDash[1]],
        left: 135,
        top: 130,
        width: 60,
        height: 30,
      ...
      text({
        context: ctx,
        textArray: ["<<fontSize:16>>width " + innerWeight],
        left: 205,
        top: 130,
        width: 60,
        height: 30,
      ...
      text({
        context: ctx,
        textArray: ["<<fontSize:16>>dash " + innerDash[0]],
        left: 270,
        top: 130,
        width: 60,
        height: 30,
      ...
      text({
        context: ctx,
        textArray: ["<<fontSize:16>>gap " + innerDash[1]],
        left: 335,
        top: 130,
        width: 60,
        height: 30,
    ...
    addListenerMove(tableBordersCanvas, function (e) {
      ...
      if (
        mouseHitRect(l + 10, t + 40, 180, 22.5) ||
        mouseHitRect(l + 210, t + 40, 180, 22.5) ||
        mouseHitRect(l + 10, t + 100, 50, 25) ||
        mouseHitRect(l + 75, t + 100, 50, 25) ||
        mouseHitRect(l + 140, t + 100, 50, 25) ||
        mouseHitRect(l + 210, t + 100, 50, 25) ||
        mouseHitRect(l + 275, t + 100, 50, 25) ||
        mouseHitRect(l + 340, t + 100, 50, 25)
      ) {
          ...
          for (var j = 0; j < draw.path[i].obj.length; j++) {
            if (
              ...
              if (mouseHitRect(l + 10, t + 40, 180, 22.5)) {
                var color =
                  e.target.colors[Math.floor((mouse.x - (l + 10)) / 22.5)];
                if (color == "none") {
                ...
                var color =
                  e.target.colors[Math.floor((mouse.x - (l + 210)) / 22.5)];
                if (color == "none") {
                ...
                draw.path[i].obj[j].outerBorder.width = Math.max(
                  1,
                  draw.path[i].obj[j].outerBorder.width - 1
                );
              } else if (mouseHitRect(l + 35, t + 100, 25, 25)) {
                draw.path[i].obj[j].outerBorder.width++;
              } else if (mouseHitRect(l + 75, t + 100, 25, 25)) {
                if (typeof draw.path[i].obj[j].outerBorder.dash !== "object")
                  draw.path[i].obj[j].outerBorder.dash = [0, 0];
                draw.path[i].obj[j].outerBorder.dash[0] = Math.max(
                  0,
                  draw.path[i].obj[j].outerBorder.dash[0] - 1
                );
                ...
                if (typeof draw.path[i].obj[j].outerBorder.dash !== "object")
                  draw.path[i].obj[j].outerBorder.dash = [0, 0];
                draw.path[i].obj[j].outerBorder.dash[1] = Math.max(
                  0,
                  draw.path[i].obj[j].outerBorder.dash[1] - 1
                );
                ...
                draw.path[i].obj[j].innerBorder.width = Math.max(
                  1,
                  draw.path[i].obj[j].innerBorder.width - 1
                );
              } else if (mouseHitRect(l + 235, t + 100, 25, 25)) {
                draw.path[i].obj[j].innerBorder.width++;
              } else if (mouseHitRect(l + 275, t + 100, 25, 25)) {
                if (typeof draw.path[i].obj[j].innerBorder.dash !== "object")
                  draw.path[i].obj[j].innerBorder.dash = [0, 0];
                draw.path[i].obj[j].innerBorder.dash[0] = Math.max(
                  0,
                  draw.path[i].obj[j].innerBorder.dash[0] - 1
                );
                ...
                if (typeof draw.path[i].obj[j].innerBorder.dash !== "object")
                  draw.path[i].obj[j].innerBorder.dash = [0, 0];
                draw.path[i].obj[j].innerBorder.dash[1] = Math.max(
                  0,
                  draw.path[i].obj[j].innerBorder.dash[1] - 1
                );
  ...
  if (typeof object.tableCellColor == "object") {
    ...
    var left = buttonPos[0];
    var top = buttonPos[1] + 53;
    var tableCellColorCanvas = createCanvas(
      left,
      top,
      110,
      110,
    ...
    addListener(tableCellColorCanvas, function (e) {
      ...
      var t = e.target.data[101];
      var color =
        this.colors[Math.floor((mouse.y - (t + 10)) / 22.5)][
          Math.floor((mouse.x - (l + 10)) / 22.5)
        ];
      for (var i = 0; i < draw.path.length; i++) {
        if (draw.path[i].selected == true) {
  ...
  if (typeof object.tableInputs == "object") {
    ...
    var tableInputsButton = createCanvas(
      buttonPos[0],
      buttonPos[1],
      55,
      55,
    ...
    tableInputsButton.draw = function () {
      ...
      text({
        ...
        width: 20,
        top: 29,
        textArray: ["<<font:Georgia>><<fontSize:10>><<align:center>>I"],
      });
    };
  ...
  if (typeof object.clone == "object") {
    ...
    cloneButton.draw = function () {
      ...
      text({
        ...
        width: 55,
        top: 15,
        textArray: ["<<font:Arial>><<fontSize:12>><<align:center>>CLONE"],
      });
    };
  ...
  if (typeof object.trigger == "object") {
    ...
    var triggerButton = createCanvas(
      buttonPos[0],
      buttonPos[1],
      55,
      55,
    ...
    triggerButton.draw = function () {
      ...
      text({
        ...
        top: 5,
        textArray: [
          "<<font:Arial>><<fontSize:14>><<align:center>>TRIG<<br>>GER",
        ],
      });
    };
  ...
  if (typeof object.ans == "object") {
    ...
    ansButton.draw = function () {
      ...
      text({
        ...
        width: 55,
        top: 15,
        textArray: ["<<font:Arial>><<fontSize:20>><<align:center>>ANS"],
      });
    };
  ...
  if (typeof object.group == "object") {
    ...
    groupButton.draw = function () {
      ...
      text({
        ...
        width: 55,
        top: 15,
        textArray: ["<<font:Arial>><<fontSize:12>><<align:center>>GROUP"],
      });
    };
  ...
  if (typeof object.delete == "object") {
    ...
    deleteButton.draw = function () {
      ...
      text({
        ...
        top: 15,
        textArray: [
          "<<font:Arial>><<fontSize:20>><<align:center>><<color:#F00>>DEL",
        ],
      });
    };
  ...
  if (typeof object.polygon == "object") {
    ...
    var polygonButton = createCanvas(
      buttonPos[0],
      buttonPos[1],
      55,
      55,
  ...
  if (typeof object.ellipse == "object") {
    ...
    var ellipseButton = createCanvas(
      buttonPos[0],
      buttonPos[1],
      55,
      55,
  ...
  if (typeof object.button == "object") {
    ...
    buttonButton.draw = function () {
      ...
      text({
        ...
        width: 55 - 16,
        top: 15,
        textArray: ["<<font:Hobo>><<fontSize:20>><<align:center>>bttn"],
      });
    };
    buttonButton.click = function () {
      ...
      setMathsInputText(mInput, [
        "<<font:Hobo>><<fontSize:32>><<align:center>>button",
      ]);
      draw.path.push({
        obj: [
          {
  ...
  if (typeof object.text == "object") {
    ...
    textButton.draw = function () {
      ...
      text({
        ...
        width: 55,
        top: 5,
        textArray: ["<<font:Arial>><<fontSize:35>><<align:center>>A"],
      });
    };
  ...
  if (typeof object.input == "object") {
    ...
    inputButton.draw = function () {
      ...
      text({
        ...
        width: 55 - 16,
        top: 15,
        textArray: ["<<font:Georgia>><<fontSize:20>><<align:center>>I"],
      });
    };
    inputButton.click = function () {
      ...
      setMathsInputText(mInput, [
        "<<font:Arial>><<fontSize:32>><<align:center>>",
      ]);
      //mInput.drawPath = draw.path[draw.path.length-1];
  ...
  if (typeof object.colorSelect == "object") {
    var colors = object.colorSelect.colors || [
      "#000",
      "#999",
      "#00F",
      "#F00",
    ...
    var colorSelectButton = createCanvas(
      buttonPos[0],
      buttonPos[1],
      55,
      55,
    ...
    var colorBackButton = createCanvas(
      left,
      top,
      120,
      220,
  ...
  if (typeof object.thicknessSelect == "object") {
    ...
    var thicknessSelectButton = createCanvas(
      buttonPos[0],
      buttonPos[1],
      55,
      55,
    ...
    var thicknessBackButton = createCanvas(
      left,
      top,
      120,
      220,
    ...
    roundedRect(
      thicknessBackButton.getContext("2d"),
      3,
      3,
      114,
      214,
    ...
    for (var i = 0; i < thicknesses.length; i++) {
      ...
      var thicknessButton = createCanvas(
        left2,
        top2,
        100,
        50,
  ...
  if (typeof object.fillColorSelect == "object") {
    var colors = object.fillColorSelect.colors || [
      "#FF0",
      "#F0F",
      "#0FF",
      "#CFC",
    ...
    var fillColorSelectButton = createCanvas(
      buttonPos[0],
      buttonPos[1],
      55,
      55,
  ...
  if (typeof object.drawStyle == "object") {
          ...
          for (var o = 0; o < path.obj.length; o++) {
            ...
            if (!un(draw[obj.type])) {
              ...
              if (!un(draw[obj.type].getLineColor)) {
                draw.drawStyleCanvas.lineColor =
                  draw[obj.type].getLineColor(obj);
              }
              if (!un(draw[obj.type].getLineWidth)) {
                draw.drawStyleCanvas.lineWidth =
                  draw[obj.type].getLineWidth(obj);
              }
              ...
              if (!un(draw[obj.type].getFillColor)) {
                draw.drawStyleCanvas.fillColor =
                  draw[obj.type].getFillColor(obj);
              }
                ...
                for (var c = 0; c < obj.cells[r].length; c++) {
                  ...
                  if (cell.selected == true) {
                    ...
                    if (!un(cell.box)) {
                      ...
                      draw.drawStyleCanvas.lineColor =
                        cell.box.lineColor || "#000";
                      draw.drawStyleCanvas.lineDash = cell.box.dash || [0, 0];
                      draw.drawStyleCanvas.fillColor =
                        cell.box.fillColor || cell.box.color || "none";
    ...
    var left = buttonPos[0];
    var top = buttonPos[1] + 53;
    var drawStyleCanvas = createCanvas(
      left,
      top,
      200,
      400,
    ...
    drawStyleCanvas.draw = function () {
      ...
      text({
        context: ctx,
        textArray: ["<<fontSize:18>>Line"],
        left: 10,
        top: t,
        width: this.data[102] - 20,
        height: 50,
        textAlign: "left",
      });
      t += 30;
      ...
      for (var r = 0; r < this.lineColors.length; r++) {
        for (var c = 0; c < this.lineColors[r].length; c++) {
          this.cursorPos.push({
            rect: [left + 10 + 22.5 * c, top + 90 + 22.5 * r, 22.5, 22.5],
            cursor: "pointer",
            color: this.lineColors[r][c],
            type: "lineColor",
          });
      ...
      text({
        context: ctx,
        textArray: ["<<fontSize:16>>width " + this.lineWidth],
        left: 5,
        top: t + 30,
        width: 60,
        height: 30,
      ...
      this.cursorPos.push({
        rect: [left + 10, top + t, 25, 25],
        cursor: "pointer",
        diff: -1,
        type: "lineWidth",
      });
      this.cursorPos.push({
        rect: [left + 35, top + t, 25, 25],
        cursor: "pointer",
        diff: 1,
        type: "lineWidth",
      });
      ...
      text({
        context: ctx,
        textArray: ["<<fontSize:16>>dash " + this.lineDash[0]],
        left: 70,
        top: t + 30,
        width: 60,
        height: 30,
      ...
      this.cursorPos.push({
        rect: [left + 75, top + t, 25, 25],
        cursor: "pointer",
        diff: -5,
        type: "lineDash",
      });
      this.cursorPos.push({
        rect: [left + 100, top + t, 25, 25],
        cursor: "pointer",
        diff: 5,
        type: "lineDash",
      });
      ...
      text({
        context: ctx,
        textArray: ["<<fontSize:16>>rad " + this.radius],
        left: 135,
        top: t + 30,
        width: 60,
        height: 30,
      ...
      this.cursorPos.push({
        rect: [left + 140, top + t, 25, 25],
        cursor: "pointer",
        diff: -5,
        type: "radius",
      });
      this.cursorPos.push({
        rect: [left + 165, top + t, 25, 25],
        cursor: "pointer",
        diff: 5,
        type: "radius",
      });
      ...
      for (var r = 0; r < this.fillColors.length; r++) {
        for (var c = 0; c < this.fillColors[r].length; c++) {
          this.cursorPos.push({
            rect: [left + 10 + 22.5 * c, top + t + 22.5 * r, 22.5, 22.5],
            cursor: "pointer",
            color: this.fillColors[r][c],
            type: "fillColor",
          });
    ...
    drawStyleCanvas.move = function (e) {
      ...
      if (typeof this.cursorPos !== "undefined") {
        for (var c = 0; c < this.cursorPos.length; c++) {
          ...
          if (
            mouseHitRect(pos.rect[0], pos.rect[1], pos.rect[2], pos.rect[3])
          ) {
  ...
  if (typeof object.align == "object") {
    ...
    button.draw = function () {
      ...
      text({
        ...
        width: 55,
        top: 15,
        textArray: ["<<font:Arial>><<fontSize:14>><<align:center>>ALIGN"],
      });
    };
    button.click = function () {
    ...
    alignCanvas.draw = function () {
      ...
      text({
        ...
        textAlign: "center",
        vertAlign: "middle",
        box: { color: "#CFC", borderWidth: 2 },
      });
      text({
        context: ctx,
        textArray: ["<<fontSize:14>>Center"],
        left: 60,
        top: 10,
        width: 50,
        height: 50,
      ...
      text({
        context: ctx,
        textArray: ["<<fontSize:14>>to margin (left)"],
        left: 10,
        top: 110,
        width: 150,
        height: 50,
      ...
      this.cursorPos.push({
        rect: [left + 10, top + 10, 50, 50],
        cursor: "pointer",
        type: "left",
      });
      this.cursorPos.push({
        rect: [left + 60, top + 10, 50, 50],
        cursor: "pointer",
        type: "center",
      });
      this.cursorPos.push({
        rect: [left + 110, top + 10, 50, 50],
        cursor: "pointer",
        type: "right",
      });
      this.cursorPos.push({
        rect: [left + 10, top + 60, 50, 50],
        cursor: "pointer",
        type: "top",
      });
      this.cursorPos.push({
        rect: [left + 60, top + 60, 50, 50],
        cursor: "pointer",
        type: "middle",
      });
      this.cursorPos.push({
        rect: [left + 110, top + 60, 50, 50],
        cursor: "pointer",
        type: "bottom",
      });
      this.cursorPos.push({
        rect: [left + 10, top + 110, 150, 50],
        cursor: "pointer",
        type: "toMargin",
      });
    };
  ...
  if (typeof object.save == "object") {
    ...
    saveButton.draw = function () {
      ...
      text({
        ...
        width: 55,
        top: 15,
        textArray: ["<<font:Arial>><<fontSize:16>><<align:center>>SAVE"],
      });
    };
  ...
  if (typeof object.load == "object") {
    ...
    loadButton.draw = function () {
      ...
      text({
        ...
        width: 55,
        top: 15,
        textArray: ["<<font:Arial>><<fontSize:16>><<align:center>>LOAD"],
      });
    };
  ...
  if (typeof object.png == "object") {
    ...
    pngButton.draw = function () {
      ...
      text({
        ...
        width: 55,
        top: 15,
        textArray: ["<<font:Arial>><<fontSize:20>><<align:center>>PNG"],
      });
    };
  ...
  if (typeof object.pdf == "object") {
    ...
    pdfButton.draw = function () {
      ...
      text({
        ...
        width: 55,
        top: 15,
        textArray: ["<<font:Arial>><<fontSize:20>><<align:center>>PDF"],
      });
    };
  ...
  if (typeof object.js == "object") {
    ...
    jsButton.draw = function () {
      ...
      text({
        ...
        width: 55,
        top: 15,
        textArray: ["<<font:Arial>><<fontSize:20>><<align:center>>JS"],
      });
    };
  ...
  if (typeof object.simpleGrid == "object") {
    ...
    var simpleGridButton = createCanvas(
      buttonPos[0],
      buttonPos[1],
      55,
      55,
  ...
  if (typeof object.dotGrid == "object") {
    ...
    var dotGridButton = createCanvas(
      buttonPos[0],
      buttonPos[1],
      55,
      55,
  ...
  if (typeof object.backGrid == "object") {
    ...
    obj.slider = createSlider({
      id: 0,
      left: buttonPos[0] - 150,
      top: buttonPos[1] + 75,
      width: 200,
      height: 50,
      linkedVar: "draw.backGrid.size",
      min: 5,
      max: 100,
      startNum: 50,
      discrete: true,
      stepNum: 5,
      visible: false,
      zIndex: draw.drawButtonZIndex + 1,
      vari: "Grid Size",
      varChangeListener: "draw.backGrid.drawBackGrid",
    });
    drawTextBox(
      obj.showButton,
      obj.showButton.ctx,
    ...
    obj.showHideBackGridMenu = function () {
      ...
      if (obj.showMenu == true) {
        ...
        for (var i = 0; i < obj.alignHorizVertButtons.length; i++) {
          ...
          showObj(
            obj.alignHorizVertButtons[i],
            obj.alignHorizVertButtons[i].data
          );
        }
    ...
    obj.hideBackGridMenu = function (e) {
      ...
      if (
        ...
        obj.alignHorizVertButtons.indexOf(e.target) == -1
      ) {
        obj.showMenu = false;
        hideObj(obj.menuCanvas, obj.menuCanvas.data);
        hideObj(obj.showButton, obj.showButton.data);
      ...
      if (draw.backGrid.show == true) {
        ...
        if (arraysEqual(draw.gridMargin, [0, 0, 0, 0]) == false) {
          ...
          ctx.strokeRect(
            m[0],
            m[1],
            draw.drawArea[2] - m[0] - m[2],
            draw.drawArea[3] - m[1] - m[3]
          );
        }
    ...
    for (var i = 0; i < 9; i++) {
      var button = createCanvas(
        buttonPos[0] - 130 + 50 * (i % 3),
        buttonPos[1] + 285 + 50 * Math.floor(i / 3),
        50,
        50,
        false,
        false,
      ...
      button.draw = function () {
        ...
        if (draw.vertSnap == this.vert && draw.horizSnap == this.horiz)
          color = "#F6F";
  ...
  if (typeof object.backGrid2 == "object") {
    // no button
    var obj = {};
    obj.canvas = createCanvas(
      draw.drawArea[0],
  ...
  if (defaultMode == "line") {
    setTimeout(function () {
      draw.cursorCanvas.style.cursor = draw.cursors.cross;
    }, 1000);
  }
...
function addDrawCanvas() {
  ...
  var canvas = createCanvas(
    draw.drawArea[0] + draw.drawRelPos[0],
    draw.drawArea[1] + draw.drawRelPos[1],
    draw.drawArea[2],
    draw.drawArea[3],
    false,
    false,
...
function changeDrawRelPos(newX, newY, includeHidden) {
  ...
  for (var c = 0; c < draw.drawCanvas.length; c++) {
    if (includeHidden == false && draw.drawCanvas[c].parentNode == "undefined")
      continue;
    if (
      includeHidden == false &&
      draw.flattenMode == true &&
      typeof draw.pathCanvas !== "undefined" &&
      draw.pathCanvas.indexOf(c) == -1 &&
      c < draw.drawCanvas.length - 2
    )
      continue;
  ...
  for (var p = 0; p < draw.path.length; p++) {
    if (!un(draw.path[p]._canvas)) {
      ...
      resizeCanvas3(
        canvas,
        canvas.drawPos + draw.drawRelPos[0],
        canvas.drawPos + draw.drawRelPos[1]
      );
    }
  }
...
function changeDrawMode(mode, altMode) {
  ...
  if (
    ["line", "rect", "square", "circle", "ellipse", "polygon"].includes(mode)
  ) {
    draw.cursors.update();
    draw.cursorCanvas.style.cursor =
      "url(" +
      draw.lineCursor +
      ") " +
      draw.lineCursorHotspot[0] +
...
function tableMenuClose() {
  ...
  if (!un(draw.tableRowColCanvas))
    hideObj(draw.tableRowColCanvas, draw.tableRowColCanvas.data);
  if (!un(draw.tableBordersCanvas))
    hideObj(draw.tableBordersCanvas, draw.tableBordersCanvas.data);
  if (!un(draw.tableCellColorCanvas))
    hideObj(draw.tableCellColorCanvas, draw.tableCellColorCanvas.data);
...
function isPosOverTool(x, y) {
  for (var i = 0; i < draw.toolOrder.length; i++) {
    if (draw.toolOrder[i] == "protractor" && draw.protractorVisible == true) {
      ...
      if (
        dist(x, y, center[0], center[1]) <= rad &&
        mouseAngle >= 0 &&
        mouseAngle <= Math.PI
      ) {
        draw.protractor.prevX = x;
        draw.protractor.prevY = y;
        draw.protractor.relSelPoint = vectorFromAToB(draw.protractor.center, [
          x,
          y,
        ]);
        if (
          ...
          return {
            ...
            func: drawClickProtractorStartRotate,
          };
        } else {
          return {
            cursor: draw.cursors.move1,
            func: drawClickProtractorStartMove,
          };
        }
      }
    }
    ...
    if (draw.toolOrder[i] == "ruler" && draw.rulerVisible == true) {
      if (hitTestPolygon([x, y], draw.ruler.verticesArray1) == true) {
        ...
        if (hitTestPolygon([x, y], draw.ruler.verticesArray2) == true) {
          return {
            cursor: draw.cursors.rotate,
            func: drawClickRulerStartRotate1,
          };
        } else if (hitTestPolygon([x, y], draw.ruler.verticesArray3) == true) {
          return {
            cursor: draw.cursors.rotate,
            func: drawClickRulerStartRotate2,
          };
        } else if (
          draw.ruler.markings == true &&
          dist(draw.ruler.center[0], draw.ruler.center[1], x, y) < 25
        ) {
          return {
            cursor: draw.cursors.ruler180,
            func: drawClickRulerRotate180,
          };
        } else {
      ...
      if (hitTestPolygon([x, y], draw.ruler.verticesArray4) == true) {
        var startPos = closestPointOnLine(
          [x, y],
          draw.ruler.edgePos1,
          draw.ruler.edgePos2
        );
        ...
        return {
          cursor: draw.cursors.rulerPen1,
          func: drawClickRulerStartDraw1,
        };
      }
      if (hitTestPolygon([x, y], draw.ruler.verticesArray5) == true) {
        ...
        draw.startY = startPos[1];
        return {
          cursor: draw.cursors.rulerPen2,
          func: drawClickRulerStartDraw2,
        };
      }
    }
    ...
    if (draw.toolOrder[i] == "compass" && draw.compassVisible == true) {
      ...
      if (dist(x, y, lockCenter[0], lockCenter[1]) <= 30) {
        ...
        dist(x, y, center2[0], center2[1]) <= 40 ||
        hitTestPolygon([x, y], draw.compass.topPolygon) == true
      ) {
        draw.compass.prevX = x;
        draw.compass.prevY = y;
        return {
          cursor: 'url("/i/cursors/rotate.cur") 12 12, auto',
          func: drawClickCompassStartDraw,
        };
      } else if (
        dist(x, y, center1[0], center1[1]) <= 30 ||
        distancePointToLineSegment(
          [x, y],
          draw.compass.center1,
        ...
        draw.compass.relCenter2 = vectorFromAToB(
          draw.compass.center1,
          draw.compass.center2
        );
        draw.compass.relCenter3 = vectorFromAToB(
          draw.compass.center1,
          draw.compass.center3
        );
        draw.compass.relLockCenter = vectorFromAToB(
          draw.compass.center1,
          draw.compass.lockCenter
        );
        return { cursor: draw.cursors.move1, func: drawClickCompassStartMove1 };
      } else if (
        dist(x, y, center3[0], center3[1]) <= 30 ||
        distancePointToLineSegment(
          [x, y],
          draw.compass.center3,
          draw.compass.center2
        ) <= 20 ||
        hitTestPolygon([x, y], draw.compass.pencilPolygon) == true
      ) {
        draw.compass.prevX = x;
        draw.compass.prevY = y;
...
function resetDrawTools(restoreStartPaths) {
  ...
  if (boolean(restoreStartPaths, true) == true)
    draw.path = draw.startPath.slice();
  ...
  if (typeof draw.compassHelpBox !== "undefined")
    hideObj(draw.compassHelpBox, draw.compassHelpBox.data);
  for (var i = 0; i < draw.colorButtons.length; i++) {
    hideObj(draw.colorButtons[i], draw.colorButtons[i].data);
  }
...
function recalcCompassValues() {
  ...
  if (draw.compass.drawOn == "right") {
    ...
    var center4 = [
      center3[0] - 200 * Math.sin(angle3),
      center3[1] - 200 * Math.cos(angle3),
    ];
  } else {
    var angle3 = -(angle2 + angle - Math.PI / 14);
    var center4 = [
  ...
  if (draw.compass.drawOn == "right") {
    var topPolygon = [
      [
        center2[0] - 62 * Math.sin(-angle) + 10 * Math.cos(angle),
        center2[1] - 62 * Math.cos(angle) - 10 * Math.sin(-angle),
      ],
      [
        center2[0] - 62 * Math.sin(-angle) - 10 * Math.cos(angle),
        center2[1] - 62 * Math.cos(angle) + 10 * Math.sin(-angle),
...
function drawCompass() {
  ...
  if (draw.compass.radiusLocked == true || draw.compass.mode == "draw") {
    ...
    ctx.lineWidth = 1;
    ctx.fillRect(
      -0.25 * draw.compass.radius,
      lockHeight - 5,
      0.5 * draw.compass.radius,
      10
    );
    ctx.strokeRect(
      -0.25 * draw.compass.radius,
