...
function drawRootSign(obj) {
  ...
  var y = [t + 0.58 * h, t + 0.5 * h, t + h, t, t];
...
function drawMathsText(
  ...
  if (!textLoc) {
    textLoc = [];
  } // array to contain details of the position of each char
  if (!horizAlign) {
    horizAlign = "left";
  }
  if (!vertAlign) {
        ...
        if (splitText[i].indexOf("<<") !== 0 && splitText[i] !== "") {
          ...
          if (
            [
              ...
              "mixedNum",
              "lim",
            ].indexOf(splitText[i]) == -1
          )
            values.chars += splitText[i].length;
        } else {
  ...
  while (mode2 !== "done") {
    ...
    for (var q = 0; q < textArray.length; q++) {
      ...
      if (logMathsTextLoc == true) {
        console.log("element:", textArray[q]);
      }
      ...
      if (typeof textArray[q] == "string") {
        // set up cursorLoc
        if (mode2 == "draw" && typeof textLoc[q] == "undefined")
          textLoc[q] = [];
        ...
        for (var section = 0; section < splitText.length; section++) {
          ...
          if (splitText[section].indexOf("<<") == 0) {
            ...
            if (
              ["algebra", "Algebra", "alg", "algText"].indexOf(fontName) > -1
            ) {
              algText = true;
            } else {
              algText = false;
            ...
            if (mode2 == "draw") {
              ...
              for (var char = 0; char < splitText[section].length; char++) {
                var tag = true;
                if (char == 0 && splitText[section].indexOf("<<tab>>") == 0)
                  tag = false;
                if (char == 0 && splitText[section].indexOf(br) == 0)
                  tag = false;
                textLoc[q].push({
                  left: leftPoint,
                  top: vertCenter - 0.5 * fontSize,
                  width:
                    context.measureText(splitText[section][char]).width +
                    2 * padding,
                  height: fontSize,
            ...
            if (
              textLoc[q].length == 0 &&
              mode2 == "draw" &&
              splitText[section].length == 0
            ) {
              if (
                typeof splitText[section + 1] !== "undefined" &&
                splitText[section + 1].indexOf("<<") !== 0
              ) {
                textLoc[q] = [
                  {
                    left: leftPoint,
                    top: vertCenter - fontSize * 0.5,
                    width: fontSize * 0.5,
                    height: fontSize,
                    fontSize: fontSize,
                  },
            ...
            if (logMathsTextLoc == true) {
              console.log("textLoc0:", textLoc[q]);
            }

            for (r = 0; r < splitText[section].length; r++) {
              if (logMathsTextLoc == true) {
                console.log("character:", splitText[section][r]);
              }
              ...
              if (mode2 == "draw") {
                if (charCode == 40) {
                  ...
                  if (elemNum < textArray.length - 1) {
                    for (
                      elemNum = q + 1;
                      elemNum < textArray.length;
                      elemNum++
                    ) {
                      if (
                        typeof textArray[elemNum] == "object" &&
                        textArray[elemNum][0] == "frac"
                      ) {
                        fracAfter = true;
                        fracElemNum = elemNum;
                        break;
                    ...
                    if (fracAfter == true) {
                      ...
                      for (elemNum = q; elemNum < fracElemNum; elemNum++) {
                        if (typeof textArray[elemNum] == "string") {
                          ...
                          for (
                            charNum = startNum;
                            charNum < textArray[elemNum].length;
                            charNum++
                          ) {
                            if (textArray[elemNum][charNum] == "(")
                              bracketCount++;
                            if (textArray[elemNum][charNum] == ")")
                              bracketCount--;
                            if (bracketCount == 0) {
                  ...
                  if (fracBefore == true) {
                    ...
                    if (tallBracket == true && fracElemNum > 0) {
                      ...
                      for (elemNum = fracElemNum - 1; elemNum >= 0; elemNum--) {
                        if (
                          typeof textArray[elemNum] == "string" &&
                          bracketCount > 0 &&
                          brk == false
                        ) {
                          for (
                            charNum = textArray[elemNum].length - 1;
                            charNum >= 0;
                            charNum--
                          ) {
                            if (
                              textArray[elemNum].substring(
                                charNum,
                                charNum + 6
                              ) == "<<br>>"
                            ) {
              ...
              if (typeof algPadding == "number") {
                if (
                  /[+/*=<>\u2264\u2265]/g.test(splitText[section][r]) == true ||
                  charCode == 215 ||
                  charCode == 247
                ) {
                ...
                if (
                  splitText[section][r] === "-" ||
                  splitText[section][r] === String.fromCharCode("0x00B1") ||
                  splitText[section][r] === String.fromCharCode("0x2213")
                ) {
                  ...
                  if (
                    ...
                    ((r == 0 &&
                      textArray[q - 1] &&
                      typeof textArray[q - 1] == "object") ||
                      /[A-Za-z0-9)]/g.test(splitText[section][r - 1]) == true)
                  ) {
                    padding = fontSize * 0.1 * algPadding;
                  } else if (
                    !un(splitText[section][r + 1]) &&
                    ["+", "-"].indexOf(splitText[section][r + 1]) > -1
                  ) {
                    padding = fontSize * 0.1 * algPadding;
                  } else if (
                    un(splitText[section][r + 1]) &&
                    typeof textArray[q + 1] === "object" &&
                    textArray[q + 1][0] === "frac"
                  ) {
              ...
              if (mode2 == "draw") {
                ...
                if (backColor !== "none")
                  backColorMe(context, textLoc[q][textLoc[q].length - 1]);
                if (selected == true) {
                ...
                if (
                  splitText[section][r] !== String.fromCharCode(0x21f4) &&
                  splitText[section][r] !== br
                )
                  context.fillText(
                    char,
                    leftPoint + leftPadding,
                    charCenter + fontSize / 20
                  );
              }
              if (logMathsTextLoc == true) {
                console.log("textLoc:", textLoc[q]);
              }
              if (splitText[section][r] == String.fromCharCode(0x21f4)) {
                // if character is a tab
                var w =
                  ceiling(leftPoint - startLeftPoint, 20 * sf) -
                ...
                leftPoint +=
                  context.measureText(char).width + leftPadding + rightPadding;
              }
        ...
        if (logMathsTextLoc == true) {
          console.log("textLocEnd1:", textLoc[q]);
        }

        // if the next element is not a string, insert cursor position to the RIGHT of the last character at end of textString
        if (
          mode2 == "draw" &&
          ((textArray[q + 1] && typeof textArray[q + 1] !== "string") ||
            !textArray[q + 1]) &&
          (typeof textArray[q] !== "string" || textArray[q].slice(-1) !== br)
        ) {
          buildArray(textLoc, q);
          textLoc[q].push({
            left: leftPoint,
        ...
        if (logMathsTextLoc == true) {
          console.log("textLocEnd2:", textLoc[q]);
        }
        ...
        var fracAlgFont =
          "italic " + fontSize * fracFontSizeMultiplier + "px Georgia";
        ...
        if (parse1.empty == true) {
          ...
          var numMeasure = drawMathsText(
            context,
            numerator,
            fontSize * fracFontSizeMultiplier,
            leftPoint,
            vertCenter,
            algText,
            [],
        ...
        if (parse2.empty == true) {
          ...
          var denomMeasure = drawMathsText(
            context,
            denominator,
            fontSize * fracFontSizeMultiplier,
            leftPoint,
        ...
        numLeft =
          leftPoint + fracPadding + fractionWidth * 0.5 - numWidth * 0.5;
        numCenter = vertCenter - 0.1 * fontSize - 0.4 * numHeight;
        numTop = numCenter - 0.5 * numHeight;

        denomLeft =
          leftPoint + fracPadding + fractionWidth * 0.5 - denomWidth * 0.5;
        ...
        if (mode2 == "draw") {
          ...
          if (backColor !== "none")
            backColorMe(context, {
              ...
              top: elementTop - 2,
              width: elementWidth,
              height: elementBottom - elementTop + 4,
            });
          context.save();
          context.font = fracFont;
          context.fillStyle = textColor;
          ...
          // draw numerator
          if (parse1.empty == true) {
            textLoc[q][1][0][0] = drawSpacingBox({
              left: numLeft,
              top: numTop,
              width: 0.84 * fracFontSizeMultiplier * fontSize,
              height: 0.84 * fracFontSizeMultiplier * fontSize,
              fontSize: 0.7 * fontSize,
            });
            if (parse1.selected !== null) selected = parse1.selected;
          } else {
            var drawObj = drawMathsText(
              context,
              numerator,
              fontSize * fracFontSizeMultiplier,
              numLeft,
          ...
          if (selected == false) {
            ...
            context.fillRect(
              leftPoint,
              vertCenter - 0.1 * fontSize,
              fractionWidth + 2 * fracPadding,
              0.3 * fontSize
            );
            context.strokeStyle = invertColor(textColor);
          }
          ...
          context.beginPath();
          context.moveTo(
            leftPoint + 0.5 * fracPadding,
            vertCenter + fontSize / 12
          );
          context.lineTo(
            leftPoint + fractionWidth + 1.5 * fracPadding,
            vertCenter + fontSize / 12
          );
          context.closePath();
          context.stroke();
          ...
          //draw denominator
          if (parse2.empty == true) {
            textLoc[q][2][0][0] = drawSpacingBox({
              left: denomLeft,
              top: denomTop + height * 0.05,
              width: 0.84 * fracFontSizeMultiplier * fontSize,
              height: 0.84 * fracFontSizeMultiplier * fontSize,
              fontSize: 0.7 * fontSize,
            });
        ...
        var elementWidth =
          symbolWidth + innerWidth + 2 * innerTextPadding + 2 * elementPadding;
        var elementHeight =
          innerHeight + 2 * innerTextPadding + 2 * elementPadding;
        var elementTop = vertCenter - elementHeight / 2;
        var elementBottom = vertCenter + elementHeight / 2;

        var innerLeft =
          leftPoint + elementPadding + symbolWidth + innerTextPadding;
        var innerTop = vertCenter - innerHeight / 2;

        var indexLeft =
          leftPoint + elementPadding + 0.3 * symbolWidth - 0.5 * indexWidth;
        ...
        if (mode2 == "draw") {
          ...
          if (parse1.empty == true) {
            textLoc[q][2][0][0] = drawSpacingBox({
              left: innerLeft + 0.05 * innerWidth,
              top: innerTop + 0.05 * innerHeight,
              width: 0.9 * innerWidth,
              height: 0.9 * innerHeight,
              fontSize: fontSize,
            });
            if (parse1.selected !== null) selected = parse1.selected;
          } else {
          ...
          drawRootSign({
            ctx: context,
            rect: [
              leftPoint + elementPadding,
              elementTop + elementPadding,
              elementWidth - 2 * +elementPadding,
              elementHeight - 2 * +elementPadding,
            ],
        ...
        if (
          algText == true &&
          typeof textArray[q - 1] == "string" &&
          /[a-zA-Z]$/g.test(textArray[q - 1]) == true
        ) {
        ...
        powerTop =
          vertCenter + 0.11 * fontSize - powerFontSize - 0.1 * powerHeight;
        ...
        function checkForFraction(textArray) {
          for (var i = 0; i < textArray.length; i++) {
            if (typeof textArray[i] == "object") {
              if (textArray[i].length > 1 && textArray[i][0] == "frac")
                return true;
        ...
        if (powerContainsFraction == true) {
          ...
          (textArray[q - 1] && textArray[q - 1][0] == "frac") ||
          (textArray[q - 2] &&
            textArray[q - 2][0] == "frac" &&
            typeof textArray[q - 1] == "string" &&
            textArray[q - 1] == "")
        ) {
        ...
        var elementWidth =
          elemWidth + innerTextWidth + 2 * bracketWidth + 4 * elemPadding;
        var elementTop = Math.min(top, innerTextTop);
        var elementBottom = Math.max(
          bottom,
          vertCenter + 0.5 * innerTextHeight
        );
        ...
        if (mode2 == "draw") {
          ...
          drawMathsText(
            ...
            "(",
            bracketFontSize,
            leftPoint + elemWidth + elemPadding,
            vertCenter - 0.05 * fontSize,
            false,
            [],
            "left",
            "middle",
          ...
          drawMathsText(
            ...
            ")",
            bracketFontSize,
            innerTextLeft + innerTextWidth + elemPadding,
            vertCenter - 0.05 * fontSize,
            false,
            [],
            "left",
        ...
        var ele1 = drawMathsText(
          context,
          textArray[q][0].slice(0, 3),
          fontSize,
          0,
          0,
          false,
        ...
        if (mode2 == "draw") {
          ...
          if (parse1.empty == true) {
            textLoc[q][1][0][0] = drawSpacingBox({
              left: baseLeft,
              top: vertCenter + 0.4 * fontSize - 0.5 * baseHeight,
        ...
        if (mode2 == "draw") {
          ...
          if (parse1.empty == true) {
            textLoc[q][1][0][0] = drawSpacingBox({
              left: powerLeft,
              top: powerTop,
              width: 0.6 * powerFontSize,
              height: 0.8 * powerFontSize,
              fontSize: 0.8 * powerFontSize,
            });
            if (parse1.selected !== null) selected = parse1.selected;
          } else {
            var drawObj = drawMathsText(
        ...
        if (textArray[q][0] == "sigma1") {
          var ele = drawMathsText(
            context,
            ["<<font:Georgia>>" + String.fromCharCode(0x03a3)],
            fontSize * 1.5,
            0,
            0,
            true,
          ...
          var ele = drawMathsText(
            context,
            ["<<font:Georgia>>" + String.fromCharCode(0x222b)],
            fontSize * 1.5,
            0,
            0,
            true,
        ...
        bottomTextMiddle =
          vertCenter + 0.5 * elemHeight + 0.5 * bottomTextHeight;
        ...
        if (mode2 == "draw") {
          ...
          if (parse1.empty == true) {
            textLoc[q][1][0][0] = drawSpacingBox({
              left: leftPoint + 0.5 * (symbolWidth - bottomTextWidth),
              top: bottomTextMiddle - 0.25 * fontSize,
              width: 0.5 * fontSize,
              height: 0.5 * fontSize,
            ...
            var drawObj = drawMathsText(
              ...
              bottomText,
              fontSize * 0.4,
              leftPoint + 0.5 * (symbolWidth - bottomTextWidth),
              bottomTextMiddle,
              true,
              [],
              "left",
          ...
          if (parse2.empty == true) {
            textLoc[q][2][0][0] = drawSpacingBox({
              left: leftPoint + 0.5 * (symbolWidth - topTextWidth),
              top: topTextMiddle - 0.25 * fontSize,
              width: 0.5 * fontSize,
              height: 0.5 * fontSize,
              fontSize: 0.5 * fontSize,
            });
            ...
            var drawObj = drawMathsText(
              ...
              topText,
              fontSize * 0.4,
              leftPoint + 0.5 * (symbolWidth - topTextWidth),
              topTextMiddle,
              true,
              [],
              "left",
          ...
          // draw innerText
          if (parse3.empty == true) {
            textLoc[q][3][0][0] = drawSpacingBox({
              left: innerTextLeft,
              top: vertCenter - 0.32 * fontSize,
              width: 0.6 * fontSize,
              height: 0.8 * fontSize,
          ...
          drawMathsText(
            ...
            ["<<font:Georgia>>" + String.fromCharCode(0x03a3)],
            fontSize * 1.35,
            leftPoint + 0.5 * (symbolWidth - elemWidth),
            elemMiddle,
            true,
            [],
            "left",
          ...
          if (selected == true) {
            ...
            if (parse1.empty == true) {
              ...
              context.strokeRect(
                leftPoint + 0.5 * (symbolWidth - bottomTextWidth),
                bottomTextMiddle - 0.25 * fontSize,
                fontSize * 0.5,
                fontSize * 0.5
              );
            } else {
        ...
        bottomTextBottom =
          vertCenter + 0.4 * elemHeight + 0.5 * bottomTextHeight;
        ...
        var symbolWidth =
          elemWidth +
          Math.max(
            bottomTextWidth - 0.1 * fontSize,
            topTextWidth + 0.15 * fontSize
          );
        ...
        if (mode2 == "draw") {
          ...
          if (parse1.empty == true) {
            textLoc[q][1][0][0] = drawSpacingBox({
              left: leftPoint - 0.1 * fontSize + elemWidth,
              top: bottomTextMiddle - 0.25 * fontSize,
              width: 0.5 * fontSize,
              height: 0.5 * fontSize,
              fontSize: 0.5 * fontSize,
            ...
            var drawObj = drawMathsText(
              ...
              bottomText,
              fontSize * 0.4,
              leftPoint - 0.1 * fontSize + elemWidth,
              bottomTextMiddle,
              true,
              [],
              "left",
          ...
          if (parse2.empty == true) {
            textLoc[q][2][0][0] = drawSpacingBox({
              left: leftPoint + 0.15 * fontSize + elemWidth,
              top: topTextMiddle - 0.25 * fontSize,
              width: 0.5 * fontSize,
              height: 0.5 * fontSize,
              fontSize: 0.5 * fontSize,
            ...
            var drawObj = drawMathsText(
              ...
              topText,
              fontSize * 0.4,
              leftPoint + 0.15 * fontSize + elemWidth,
              topTextMiddle,
              true,
              [],
              "left",
        ...
        if (mode2 == "draw") {
          ...
          for (var k = 0; k < innerText[0].length; k++) {
            if (
              "0123456789QWERTYUIOPASDFGHJKLZXCVBNMtlkhfdb|(){}[]/?!£$%&".indexOf(
                innerText[0][k]
              ) > -1
            ) {
        ...
        if (mode2 == "draw") {
          ...
          // right bracket
          var rLeft =
            leftPoint + bracketWidth + maxWidth + (2 / 3) * bracketWidth;
          ...
          if (selected == true) {
            ...
            context.fillStyle = selBackColor;
            context.fillRect(
              leftPoint + bracketWidth + maxWidth,
              rTop - 1.5 * rRadius,
              bracketWidth,
              rBottom - rTop + 3 * rRadius
            );
          }
        ...
        var elementBottom = Math.max(
          bottom,
          denomTop + denomHeight,
          vertCenter + 0.5 * intHeight
        );
        ...
        if (mode2 == "draw") {
          ...
          if (selected == false) {
            ...
            context.fillColor = selBackColor;
            context.fillRect(
              leftPoint + intWidth + 0.5 * fracPadding,
              vertCenter - 0.1 * fontSize,
              fractionWidth + fracPadding + 0.1 * fontSize,
              0.3 * fontSize
            );
            context.strokeStyle = invertColor(textColor);
          }
          ...
          context.lineTo(
            leftPoint + intWidth + fractionWidth + 1.5 * fracPadding,
            vertCenter + fontSize / 12
          );
          context.closePath();
          context.stroke();
        ...
        var elementTop = Math.min(
          top,
          vertCenter - 0.5 * limHeight,
          vertCenter - 0.5 * innHeight
        );
        var elementBottom = Math.max(
          bottom,
          numCenter + 0.5 * numHeight,
          vertCenter + 0.5 * innHeight
        );
        ...
        if (mode2 == "draw") {
          ...
          if (parse2.empty == true) {
            textLoc[q][2][0][0] = drawSpacingBox({
              left: leftPoint + maxWidth + padding,
              top: vertCenter - 0.4 * fontSize,
              width: 0.7 * fontSize,
              height: 0.8 * fontSize,
              fontSize: 0.8 * fontSize,
