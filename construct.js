    ...
    obj: [
      {
        ...
        interact: {
          click: function () {
            ...
            o("protractorButton").box.color =
              draw.protractor.numbers === true ? "#F90" : "#FFC";
            drawToolsCanvas();
          },
        },
        visible: false,
...
/*
var moreInteractivesButton = newctx({
  rect: [0, 0, 325, 40],
  z: 200000000000,
  vis: true,
  pE: true,
    ...
    obj: [
      {
        ...
        text: [
          "<<align:right>><<font:Hobo>><<fontSize:28>><<color:#00F>>More Interactive Tools...",
        ],
        align: [0, 0],
      },
    ],
...
homeImage.onload = function () {
  ...
  for (var i = 0; i < length; i += 4) {
    if (
      homeImage.imageData[i] >= 245 &&
      homeImage.imageData[i + 1] >= 245 &&
      homeImage.imageData[i + 2] >= 245
    ) {
...
function handleDrop(e) {
  ...
  if (e.dataTransfer.files.length == 0) {
    ...
    div.innerHTML = img;
    if (
      un(div.getElementsByTagName("img")[0]) ||
      un(div.getElementsByTagName("img")[0].src)
    ) {
      return;
    }
    ...
    aImg.onload = function () {
      ...
      if (
        ...
        !un(draw.path[0]) &&
        !un(draw.path[0].obj) &&
        !un(draw.path[0].obj[0]) &&
        draw.path[0].obj[0].type == "image"
      ) {
        draw.path.shift();
      }
      draw.path.unshift({
      ...
      if (j227backImgAdded == false) {
        j227imgSlider = createSlider({
          ...
          min: 0.1,
          max: 1.5,
          linkedVar: "j227imgScale",
          varChangeListener: "j227imgScaleChange",
          startNum: 1,
          label: false,
          zIndex: 1000,
        });
